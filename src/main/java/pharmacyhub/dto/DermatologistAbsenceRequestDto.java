...
public class DermatologistAbsenceRequestDto {
	...
	public DermatologistAbsenceRequestDto() {
		
	}
	
	public DermatologistAbsenceRequestDto(String pharmacistName, String pharmacistSurname, Date startDate, Date endDate,
			String reason, String requestId, String drugstores) {
		super();
