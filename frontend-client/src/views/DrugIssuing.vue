    ...
    <b-container>
        <b-modal id="my-modal" title="Drug issuing" hide-footer>
            <b-form @submit="onSubmit">
                <b-form-group
                    ...
                    label-for="reservationid-input"
                    invalid-feedback="Reservation id is requred"
                >
                    <b-form-input
        ...
        <b-row>
            <b-col>
                ...
                ></b-table>
                <h1 v-if="noResults">
                    There are no reservations of patient in this drugstore!
                </h1>
            </b-col>
        </b-row>
...
export default {
    ...
    methods: {
        search: function() {
            this.$http
                .get(
                    "http://localhost:8081/drugReservation/getPatientReservationsInDrugstore",
                    {
                        params: {
        ...
        onSubmit(event) {
            ...
            this.$http
                .get("http://localhost:8081/drugReservation/issueReservation", {
                    params: {
