<template>
  ...
  <div>
    <router-link to="/my-drugstore">
      <b-button style="margin-top:40px; margin-bottom:40px; margin-right:100px;" type="button" variant="outline-hub" size="lg">Cancel</b-button>
    </router-link>
    <router-link to="/my-drugstore">
      <b-button style="margin-top:40px; margin-bottom:40px; margin-left:100px;" type="button" variant="outline-hub" @click="saveChanges" size="lg">Save changes</b-button>
    </router-link>
  </div>
  </b-containter>
</template>
    ...
    methods: {
        getSelectedDrugstoreInfo : function() {
            this.$http.get('http://localhost:8081/drugstores/adminsDrugstore', {
                ...
                this.$http.put("http://localhost:8081/drugstores/update", this.drugstore)
                    .then(() => {
