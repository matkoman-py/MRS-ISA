        ...
        <b-row style="margin:20px">
            ...
            <b-col style="padding-left:25px;">
                <div align="left" style="margin-top:30px">
                    ...
                    <b-button variant="outline-hub" style="margin:20px" v-if="subscribed == false" @click="subscribe">
                        Subscribe</b-button>
                    ...
                    <b-table :items="dermatologists" :fields="dTableFields">
                        <template #cell(rateActionD)="row">
                            <b-button variant="outline-hub" v-if="row.item" size="sm"
                                @click="showModalD(row.item, row.index, $event.target)" class="mr-1">
                                Rate
                            </b-button>
                        </template>
                    </b-table>
                ...
                <div style="margin-top:20px; margin-left:20px; margin-right:20px; border-style:solid;">
                    <b-table :items="pharmacists" :fields="pTableFields">
                        <template #cell(rateActionP)="row">
                            <b-button variant="outline-hub" v-if="row.item" size="sm"
                                @click="showModalP(row.item, row.index, $event.target)" class="mr-1">
                                Rate
                            </b-button>
                        </template>
                    </b-table>
        ...
        methods: {
            ...
            showModalP(item) {
                ...
                for (i = 0; i < this.pharmacistappointments.length; i++) {
                    ...
                    //alert(item.surname);
                        if(this.pharmacistappointments[i].pharmacist == item.name &&
            ...
            showModalD(item) {
                ...
                for (i = 0; i < this.dermatologistappointments.length; i++) {
                    ...
                    //alert(item.name);
                        if(this.dermatologistappointments[i].dermatologist == item.name && 
