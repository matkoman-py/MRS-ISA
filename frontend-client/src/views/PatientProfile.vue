                    ...
                    <div class="col-md-12">
                        <b-card no-body>
                            <b-tabs>
                                ...
                                <b-tab
                                    style="height: 370px;"
                                    title="Drug reservations"
                                >
                                    <b-card style="border: none;">
                                        <b-table
                                            v-if="drugReservations.length != 0"
                                            striped
                                            hover
                                ...
                                >
                                    ...
                                    >
                                        <b-card>
                                            <h3>
                                                Choose an ingrediant from the
                                                list and add it to your list of
                                                allergens
                                            </h3>
                                            <br />
                                            <b-form-select
                                                v-model="alergenToAdd"
                                                :options="ingrediants"
                                                value-field="id"
                                                text-field="name"
                                            >
                                            ...
                                            <br />
                                            <b-button
                                                :disabled="alergenToAdd == null"
                                                type="submit"
                                                variant="outline-hub"
                                                >Add alergen</b-button
                                            >
                                        </b-card>
                                    </b-form>
                                </b-tab>
...
export default {
    ...
    methods: {
        ...
        oldPasswordValidate: function(event) {
            ...
            var valid = false;
            this.$http
                .get("http://localhost:8081/user/password", {
                    params: {
                        drugstoreAdminId: this.user.id,
        ...
        changePassword: function() {
            if (this.validatePassword1()) {
                ...
                this.$http
                    .put(
                        "http://localhost:8081/user/updatepassword",
                        this.profile
                    )
                    .then(() => {
                        this.$toastr.s(
                            "You succesfully updated your password!"
                        );
        ...
        AddAlergens: function() {
            this.$http
                .get("http://localhost:8081/patients/add-alergen", {
                    params: {
                ...
                .then((response) => {
                    ...
                    else this.$toastr.s(response.data);
                })
                .catch((error) => console.log(error));
        },
        ...
        cancelPharmacistAppointment(item) {
            ...
            if (dateOfReservation <= dateNow) {
                this.$toastr.e(
                    "You can't cancel appointments one or more days before they are due"
                );
                return;
            }
            this.$http
                ...
                .then(
                    this.$toastr.s(
                        "Pharmacist appointment succesfully canceled!"
                    )
                )
                .catch((error) => console.log(error));
        },
        cancelDermatologyAppointment(item) {
            ...
            this.$http
                ...
                .then((response) => {
                    ...
                    else this.getDermatologyAppointments();
                ...
                .then(
                    this.$toastr.s(
                        "Dermatology appointment succesfully canceled!"
                    )
                )
                .catch((error) => console.log(error));
        },
        reservationNotPickedUp() {
            for (var drug in this.drugReservations) {
                if (this.drugReservations[drug].date == this.today) {
                    this.$http
                        .get("http://localhost:8081/patients/penalty", {
                            params: {
        ...
        cancelDrugReservation(item) {
            ...
            if (dateOfReservation <= dateNow) {
                this.$toastr.e(
                    "You can't cancel reservations one or more days before they are due"
                );
                return;
            }
            this.$http
        ...
        handleSubmit: function(event) {
            ...
            this.$http
                ...
                .then(() => {
                    this.$toastr.s(
                        "You succesfully updated your profile information!"
                    );
                })
                .catch((error) => console.log(error));
        },
        ...
        getDrugReservations: function() {
            this.$http
                .get(
                    `http://localhost:8081/drugReservation/getPatientReservations?page=${this
            ...
            this.$http
                .get(
                    `http://localhost:8081/pharmacist-appointment/get-appointments?page=${this
                        .currentPagePharmacist - 1}&size=3`,
                    {
                        params: {
                            patientId: this.user.id,
                        },
            ...
            this.$http
                .get(
                    `http://localhost:8081/dermatologist-appointment/returnAppointments?page=${this
                        .currentPageDermatologist - 1}&size=3`,
                    {
                        params: {
                            patientId: this.user.id,
                        },
